...
public class Camera2ConnectionFragment extends Fragment {
  ...
  public static Camera2ConnectionFragment newInstance() {
    return new Camera2ConnectionFragment();
  }
...
//        }
        ...
        Camera2ConnectionFragment.this.cameraId = cameraId;
        return;
      }
  ...
  /**
   * Opens the camera specified by {@link Camera2ConnectionFragment#cameraId}.
   */
